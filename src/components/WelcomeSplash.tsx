    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          />
          <div className="absolute top-[20%] right-[15%] w-[45vw] h-[45vw] max-w-[350px] max-h-[350px] bg-purple-600/15 rounded-full filter blur-[100px]" />
          <div className="absolute bottom-[20%] left-[15%] w-[45vw] h-[45vw] max-w-[350px] max-h-[350px] bg-pink-600/10 rounded-full filter blur-[110px]" />
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-md w-full space-y-7">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <motion.div
              ...
              className="absolute w-36 h-36 md:w-44 md:h-44 rounded-full border border-indigo-500/30"
            />
            <motion.div
              animate={{
                scale: [1, 1.45, 1],
              ...
              className="absolute w-48 h-48 md:w-56 md:h-56 rounded-full border border-purple-500/20"
            />
            ...
            <motion.div
              ...
              className="relative w-24 h-24 md:w-28 md:h-28 rounded-3xl bg-gradient-to-tr from-indigo-600 via-purple-600 to-pink-500 p-[2px] shadow-[0_0_50px_rgba(99,102,241,0.5)]"
            >
              <div className="w-full h-full bg-[#09090e] rounded-[22px] flex items-center justify-center relative overflow-hidden">
                ...
                <Disc className="w-12 h-12 md:w-14 md:h-14 text-indigo-400 animate-spin-slow" />
              </div>
            </motion.div>
          </div>
          ...
          >
            {[0.4, 0.8, 1, 0.6, 0.9, 0.5, 0.7, 1, 0.4].map((scale, i) => (
              <motion.span
                ...
                className="w-1 h-6 rounded-full bg-gradient-to-t from-indigo-500 to-purple-400"
              />
            ))}
          </motion.div>
