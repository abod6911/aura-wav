...
export const MiniPlayer: React.FC<MiniPlayerProps> = ({ onExpand }) => {
  ...
  return (
    <motion.div
      ...
      className="md:hidden fixed bottom-[calc(66px+env(safe-area-inset-bottom,0px))] left-2.5 right-2.5 z-40 bg-[#161622]/90 backdrop-blur-3xl border border-white/[0.14] rounded-2xl p-2 sm:p-2.5 shadow-[0_16px_45px_rgba(0,0,0,0.85)] flex items-center gap-3 select-none overflow-hidden touch-pan-y cursor-pointer active:scale-[0.99] transition-transform"
      dir={dir}
    >
