        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-white/[0.08] pb-3.5">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-2xl bg-indigo-500/15 border border-indigo-500/25 text-indigo-400">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-13 h-7 rounded-full p-1 transition-colors relative flex items-center cursor-pointer shadow-inner ${
                  automixEnabled ? 'bg-indigo-600 shadow-indigo-600/30' : 'bg-white/10'
                }`}
              >
                <div
            ...
            {automixEnabled && (
              <div className="pt-2 border-t border-white/[0.06] space-y-2">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="text-indigo-300 font-bold font-mono px-2 py-0.5 rounded-md bg-indigo-500/15 border border-indigo-500/20">
          ...
          <div className="rounded-2xl p-4 sm:p-5 border border-indigo-500/20 bg-gradient-to-r from-indigo-950/30 via-purple-950/20 to-black/40 relative overflow-hidden space-y-3">
            {/* Bass Ambient Glow */}
            <div
              className="absolute -right-10 -top-10 w-36 h-36 rounded-full bg-indigo-500/20 blur-2xl pointer-events-none transition-opacity duration-300"
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`p-2.5 rounded-xl border transition-all duration-300 ${
                    bassBoost > 0
                      ? 'bg-indigo-500/20 border-indigo-500/40 text-indigo-400 shadow-[0_0_16px_rgba(99,102,241,0.4)]'
            ...
            <div dir="ltr" className="pt-1 space-y-1">
              ...
              <div className="flex justify-between text-[10px] font-mono text-zinc-500">
                ...
                <span>متوسط (+6dB)</span>
                <span>عميق (+12dB)</span>
                <span className="text-indigo-400 font-bold">زلزال (+18dB)</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-4 sm:p-5 bg-white/[0.025] border border-white/[0.08] space-y-4">
            ...
            <div className="relative w-full h-20 bg-black/40 rounded-xl border border-white/[0.06] overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-between py-2 px-3 pointer-events-none opacity-30 text-[9px] font-mono text-zinc-400">
                ...
                <div className="border-b border-white/30 pb-0.5 text-indigo-300">0dB (Flat)</div>
              ...
              <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                ...
                {points.map((p, i) => (
                  <circle key={i} cx={p.x} cy={p.y} r="2.5" fill="#ffffff" stroke="#8b5cf6" strokeWidth="1" />
                ))}
              </svg>
            </div>
                  ...
                  <div key={band.freq} className="flex flex-col items-center h-full justify-between group">
                    ...
                    >
                      <input
                        ...
                        className="accent-indigo-500 cursor-pointer -rotate-90 w-24 sm:w-28 origin-center"
                      />
                    </div>
